...
private:
  ...
  bool puzzle_solvability_;//indicates whether or not current puzzle is able to solved or not
  int **puzzle_numbers_;//initalizing the 2D array that'll hold the values of the suduku board
};
#endif
